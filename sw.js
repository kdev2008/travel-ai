/* Travel AI service worker — build 4.4
...
self.addEventListener('fetch', event => {
  ...
  // Published country JSON is versioned (?v=) and stored in IndexedDB by the app:
  // let the browser/CDN handle it so this cache never grows without limit.
  if (url.pathname.includes('/data/countries/')) return;
